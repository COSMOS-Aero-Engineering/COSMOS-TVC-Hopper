...
| `docs/execution/TIMELINE.md` | **전체 타임라인 한 장 요약(신규)** — Mermaid 간트차트(팀별 트랙, 완료/진행/병목 색 구분), 한 것·남은 것 표, 현재 병목 3개. 세부는 아래 문서들로 링크만 | 신규, 2026-09-20 |
...
| "지금 전체적으로 어디까지 왔지? 뭐가 남았지?" | `docs/execution/TIMELINE.md` — **한 장 요약(간트차트)** |
